...
import { Activity, FileText, Users, BookOpen } from "lucide-react"

export const metadata: Metadata = {
    title: "Dashboard",
    description: "Your research workspace dashboard",
}
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">+1 new collaborator</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
